-- Corregir paid_installments basándome en pagos reales de liquidaciones emitidas
-- Este script recalcula paid_installments y remaining_amount para todos los préstamos activos
...
DECLARE
    ...
    new_status TEXT;
BEGIN
    -- Iterar sobre todos los préstamos activos
    FOR loan_record IN 
        SELECT 
            l.id,
            l.loan_number,
    ...
    RAISE NOTICE 'Corrección de paid_installments completada.';
END $$;
